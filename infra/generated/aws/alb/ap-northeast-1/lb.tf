resource "aws_lb" "tfer--nestjs-002D-api" {
  ...
  subnets = ["${data.terraform_remote_state.subnet.outputs.aws_subnet_tfer--subnet-002D-008d1b86200d30812_id}", "${data.terraform_remote_state.subnet.outputs.aws_subnet_tfer--subnet-002D-0250822fb6f465ba5_id}"]
}
